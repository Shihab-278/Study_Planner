<x-layouts.study title="Edit Task">
    <div class="max-w-lg">
        <form method="POST" action="{{ route('tasks.update', $task) }}" class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            @csrf @method('PUT')
            <div class="mb-5">
            ...
            <div class="mb-5">
                ...
                <textarea name="description" id="description" rows="3"
                          class="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none resize-none transition">{{ old('description', $task->description) }}</textarea>
